  ...
  return (
    <>
      <Block flex backgroundColor={Color.gray}>
        ...
        <Block animated paddingTop={30}>
          {itemSystem(3, changePass)}
          <Button
            nextScreen={loadSMethod}
            shadow
            height={60}
            justifyContent={"space-between"}
            alignCenter
          ...
          >
            <MaterialCommunityIcons
              name={isReceiveNotification === "Y" ? "bell-ring" : "bell"}
              size={20}
              style={{ marginLeft: 5, color: Color.mainColor }}
            />
            <Text
        ...
        {/* modal of change language */}
        {modal}
        {/* modal of change pass */}
        {modalCheckLogin}
        {modalPasss}
        {modalChangePass}
        {modalConfirm}
