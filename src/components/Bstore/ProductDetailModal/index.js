...
const ProductDetailModal = ({ visible, product, onClose, listCategory, onAddToCart }) => {
  ...
  const handleQuantityBlur = () => {
    if (!manualQuantity || Number.parseFloat(manualQuantity) <= 0 || isNaN(Number.parseFloat(manualQuantity))) {
      setManualQuantity("1")
      setQuantity(1)
    }
  }
  ...
  const handleAddToCart = () => {
    ...
    const cartItem = {
      ...
      tco_depot_pk: source.tco_depot_pk || product.tco_depot_pk,
      image_uri: product.image_uri,
      prod_nm: product.prod_nm,
      quantity: quantity,
      unit_price: source.unit_price || product.prod_unit_price,
      price: source.unit_price || product.prod_unit_price, // Giữ lại price để hiển thị
      price_type: selectedSize ? selectedSize.price_type : "01",
        ...
        <View style={styles.modal}>
          ...
          <View style={styles.contentRow}>
            ...
            <View style={styles.infoColumn}>
              ...
              <Text style={styles.productDescription}>{getCurrentDescription()}</Text>
            </View>
          </View>
